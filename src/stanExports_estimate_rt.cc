...
#include "stanExports_estimate_rt.h"

RCPP_MODULE(stan_fit4estimate_rt_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_estimate_rt")
