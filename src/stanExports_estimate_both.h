...
namespace model_estimate_both_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_estimate_both");
    reader.add_event(117, 115, "end", "model_estimate_both");
    return reader;
}
int
r_in(const int& pos,
...
class model_estimate_both
  : public stan::model::model_base_crtp<model_estimate_both> {
private:
        int T;
        int N;
        ...
        double prior_std;
public:
    model_estimate_both(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_estimate_both_namespace::model_estimate_both";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "population", "double", context__.to_vec(N));
            population = std::vector<double>(N, double(0));
            vals_r__ = context__.vals_r("population");
            pos__ = 0;
            size_t population_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < population_k_0_max__; ++k_0__) {
                population[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 35;
            validate_non_negative_index("dist_mat", "N", N);
            validate_non_negative_index("dist_mat", "N", N);
            context__.validate_dims("data initialization", "dist_mat", "double", context__.to_vec(N,N));
            dist_mat = std::vector<std::vector<double> >(N, std::vector<double>(N, double(0)));
            vals_r__ = context__.vals_r("dist_mat");
            pos__ = 0;
            size_t dist_mat_k_0_max__ = N;
            size_t dist_mat_k_1_max__ = N;
            for (size_t k_1__ = 0; k_1__ < dist_mat_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < dist_mat_k_0_max__; ++k_0__) {
                    dist_mat[k_0__][k_1__] = vals_r__[pos__++];
                }
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_lub_unconstrain(1, 2, gamma);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 48;
        if (!(context__.contains_r("pstay")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable pstay missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("pstay");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "pstay", "double", context__.to_vec());
        double pstay(0);
        pstay = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, pstay);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable pstay: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                gamma = in__.scalar_lub_constrain(1, 2, lp__);
            else
                gamma = in__.scalar_lub_constrain(1, 2);
            current_statement_begin__ = 48;
            local_scalar_t__ pstay;
            (void) pstay;  // dummy to suppress unused var warning
            if (jacobian__)
                pstay = in__.scalar_lub_constrain(0, 1, lp__);
            else
                pstay = in__.scalar_lub_constrain(0, 1);
            // model body
            {
            current_statement_begin__ = 53;
            validate_non_negative_index("flow", "N", N);
            validate_non_negative_index("flow", "N", N);
            std::vector<std::vector<local_scalar_t__  >  > flow(N, std::vector<local_scalar_t__>(N, local_scalar_t__(DUMMY_VAR__)));
            stan::math::initialize(flow, DUMMY_VAR__);
            stan::math::fill(flow, DUMMY_VAR__);
            ...
            validate_non_negative_index("pmovement", "N", N);
            std::vector<std::vector<local_scalar_t__  >  > pmovement(N, std::vector<local_scalar_t__>(N, local_scalar_t__(DUMMY_VAR__)));
            stan::math::initialize(pmovement, DUMMY_VAR__);
            stan::math::fill(pmovement, DUMMY_VAR__);
            ...
            for (int r = 1; r <= N; ++r) {
                ...
                for (int c = 1; c <= N; ++c) {
                    ...
                    if (as_bool(logical_eq(r, c))) {
                        current_statement_begin__ = 65;
                        stan::model::assign(flow, 
                                    stan::model::cons_list(stan::model::index_uni(r), stan::model::cons_list(stan::model::index_uni(c), stan::model::nil_index_list())), 
                                    0, 
                                    "assigning variable flow");
                    } else {
                        current_statement_begin__ = 67;
                        stan::model::assign(flow, 
                                    stan::model::cons_list(stan::model::index_uni(r), stan::model::cons_list(stan::model::index_uni(c), stan::model::nil_index_list())), 
                                    (((K * pow(get_base1(population, r, "population", 1), alpha)) * pow(get_base1(population, r, "population", 1), beta)) / pow(get_base1(get_base1(dist_mat, r, "dist_mat", 1), c, "dist_mat", 2), gamma)), 
                                    "assigning variable flow");
                    }
                }
            }
            ...
            for (int r = 1; r <= N; ++r) {
                ...
                stan::math::assign(row_total, sum(get_base1(flow, r, "flow", 1)));
                current_statement_begin__ = 77;
                for (int c = 1; c <= N; ++c) {
                    current_statement_begin__ = 78;
                    stan::model::assign(flow, 
                                stan::model::cons_list(stan::model::index_uni(r), stan::model::cons_list(stan::model::index_uni(c), stan::model::nil_index_list())), 
                                (get_base1(get_base1(flow, r, "flow", 1), c, "flow", 2) / row_total), 
                                "assigning variable flow");
                }
            }
            ...
            for (int r = 1; r <= N; ++r) {
                ...
                for (int c = 1; c <= N; ++c) {
                    ...
                    if (as_bool(logical_eq(r, c))) {
                        ...
                        stan::model::assign(pmovement, 
                                    stan::model::cons_list(stan::model::index_uni(r), stan::model::cons_list(stan::model::index_uni(c), stan::model::nil_index_list())), 
                                    pstay, 
                                    "assigning variable pmovement");
                    } else {
                        current_statement_begin__ = 88;
                        stan::model::assign(pmovement, 
                                    stan::model::cons_list(stan::model::index_uni(r), stan::model::cons_list(stan::model::index_uni(c), stan::model::nil_index_list())), 
                                    (get_base1(get_base1(flow, r, "flow", 1), c, "flow", 2) * (1 - pstay)), 
                                    "assigning variable pmovement");
                    }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_estimate_both_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double gamma = in__.scalar_lub_constrain(1, 2);
        vars__.push_back(gamma);
        double pstay = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(pstay);
        double lp__ = 0.0;
...
typedef model_estimate_both_namespace::model_estimate_both stan_model;
#ifndef USING_R
